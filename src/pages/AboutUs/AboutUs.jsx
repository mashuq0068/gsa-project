...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-10">
      <section className="container mx-auto mt-24 text-center px-6">
        <h1 className="text-5xl font-medium mb-6">About Us</h1>
        <p className="max-w-3xl  mb-4  text-gray-300 font-light leading-relaxed   w-max mx-auto">
      ...
      <section className="container mx-auto text-center px-6 mt-16">
